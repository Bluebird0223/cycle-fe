...
const Product = ({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 p-4 mx-2 relative">
      {/* NEW Badge */}
      <div className="absolute top-2 right-2 bg-indigo-800 text-white text-xs font-semibold px-2 py-1 rounded">NEW</div>
