...
import { removeFromSaveForLaterApi } from "../../store/saveForLaterSlice";
...
const SaveForLaterItem = ({
  ...
  const removeFromSaveForLaterHandler = (id) => {
    dispatch(removeFromSaveForLaterApi(id));
  ...
  const moveToCartHandler = (product, quantity) => {
    ...
    removeFromSaveForLaterHandler(product?._id);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-1 sm:gap-5 w-full p-1 pr-6">
          ...
          <div className="flex justify-between items-start pr-5">
            <div className="flex flex-col gap-0.5 w-11/12 sm:w-full capitalize">
      ...
      <div className="flex justify-evenly sm:justify-start sm:gap-6">
        ...
        <button
          onClick={() => removeFromSaveForLaterHandler(_id)}
