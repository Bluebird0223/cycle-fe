...
const OrderSuccess = ({ success }) => {
  ...
  return (
    <>
      ...
      <main className="w-full pt-3 pb-10 bg-primary-beige">
        {/* <!-- row --> */}
        <div className="flex flex-col gap-2 items-center justify-center sm:w-4/6 sm:mt-4 m-auto bg-white shadow rounded p-6 pb-12">
          <img
            draggable="false"
