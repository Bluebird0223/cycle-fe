...
const UpdateCoupon = () => {
    ...
    return (
        <>
            <MetaData title="Admin: Update Coupon | KanchanDeepJyot" />
            ...
            <div className="flex flex-col bg-white shadow-lg rounded-lg mx-auto w-lg max-w-xl">
                ...
                <form onSubmit={updateSubmitHandler} className="p-5 sm:p-10">
                    <div className="flex flex-col gap-3 items-start">
                        ...
                        <button type="submit" className="text-white py-3 w-full bg-primary-orange shadow hover:shadow-lg rounded-sm font-medium" value="submit">Update Coupon</button>
