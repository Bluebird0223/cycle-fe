    ...
    return (
        <>
            <div className="flex justify-between items-center gap-3">
                {editRoute !== "review" && (
                    <Link to={`/admin/${editRoute}/${id}`} className="text-red-800 hover:bg-blue-200 p-1 rounded-full bg-blue-100">
                        <EditIcon />
                    </Link>
                )}
            ...
            >
                ...
                <DialogActions>
                    ...
                    <button 
                        ...
                        className="py-2 px-6 ml-4 rounded bg-red-600 hover:bg-red-700 text-white shadow flex items-center gap-2"
                        disabled={isDeleting}
                    >
                        {isDeleting ? (
                            <>
